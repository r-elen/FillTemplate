...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.comboBox_services.setObjectName(u"comboBox_servises")
        sizePolicy3 = QSizePolicy(QSizePolicy.Ignored, QSizePolicy.Minimum)
        sizePolicy3.setHorizontalStretch(0)
        sizePolicy3.setVerticalStretch(0)
        sizePolicy3.setHeightForWidth(self.comboBox_services.sizePolicy().hasHeightForWidth())
        self.comboBox_services.setSizePolicy(sizePolicy3)
        ...
        sizePolicy4.setHeightForWidth(self.createDocButton.sizePolicy().hasHeightForWidth())
        self.createDocButton.setSizePolicy(sizePolicy4)
